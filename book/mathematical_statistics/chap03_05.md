...
For test $\bar{\phi} \in \Phi_{\alpha}$, $\bar{\phi}$ is said to be the most powerful test at level $\alpha$ if
...
$\phi$ is the most powerful test for hypothesis $\Theta_{H$}$ and alternatives $\Theta_{K}$.
