...
* point
    ...
    * point out
        ...
        * Dr. Hannay also points out that making these recordings is legal and allowed by Facebook’s user agreement. 
* view
...
* compare
    ...
    * we've found that thinking through and recording the best practices ahead of time in a playbook produces roughly a 3x improvement in MTTR as compared to the strategy of winging it
* bubble
...
* settle
    * settle for/accept
        * to accept or agree to sth, or to decide to have sth, although it is not exactly what you want or it is not the best
        * They asked for a 5% salary increase, but had to settle for 3%
        * He wants a full refund and he won't settle for anything les
...
* sketchy
    ...
    * not safe
        ...
        * a sketchy guy
        * they lived in a sketchy neighborhoodr
...
* free
    * free up
        ...
        * As soon as SRE activities are conceptualized in this framework, freein up the error budget through tactics suc as phased rollouts and 1% experiemts can optimize for quicker launches
* quantitative
* cutover
...
* go
    * on the go
        ...
        * It also includes other features aimed at making it easy to access these calls while on the go
    * go through
        * be accepted
    ...
    * go through sth
        ...
        * examine
            * to examine sth that contains a collection of things carefully in order to organize them to find sth
            * I'm going through my wardrobe and throwing out all the clothes I don't wear any more.
        * practise
            * to do sth in order to practise or as a test
...
* turn
    ...
    * trun over sth
        * if a business turns over a particular amount of money, it does that the amount of business during a started period
        * to make a particular amount of money from sales in a particular period
        * The company turned over 340 million dollars last year.
        * to change to a different television staion
        * this programme's boring - can I turn over to BBC?
        * use
            * to use or allow sth to be used for a different purpose
            * Grants are being offered to farmars who agree to turn over their land to parkland
        * think
            * to think about sth for a period of time
            * his father had been turning the idea over in his mind for some time
    * turn sth over to sth/sb
        * to give sth to a person or legal authority
    * turn up
...
* surge
    * while a spike in traffic to the app around 20:45 could explain a bref surge in resource usage
* ban/prohibit
...
* distance
    * we distance ourselves more from the topic or from aspects of the topic
* short
    * distance
    * time
    * lacking
...
* conceive
    ...
    * become pregnant
        * The baby was conceived in April, so it will be born in January.
* disciplined
...
* entitlement
    * the official right to have or do sth, or the amount that you have a right to receive
* entail
...
* race
    * while companies race to make self-driving cars, there's another race going on
    * competition
    * people
        * discrimination because of race is against the law
    * compete
        * to compete in a race or run a race with sb
            * he's been racing cars for over ten years
        * to race is also to move fast or to happen quickly
            * the boy came racing across the playground
...
* match
    * game
        ...
        * home/away match
            ...
            * his goal earned him the title of man of the match
    * fire
        * a box of matches
        * don't let your child with matches
...
* respective
    ...
    * he and he ordered their respective Cabinets to devise a common counter-drug strategy
* counter-drug
...
* intervention
    ...
    * Even if a given system experiences more actual system, a system that can avoid emergencies that require human intervention will have higher availability than a system that requires hands-on intervention
    * intervention study
        * Interventional studies are often performed in laboratories and clinical studies to establish beneficial effects of drugs or procedures
    ...
    * intervention in sth
        * Any intervention in the currency market has to be followed by a tightend of monetary policy
* wing
    * structure for lying
    * political group
    * part of building
...
* spin
    * Adding new capacity often involves spinning up a new instance or location, making significant modification to existing systems, and validating that the new capacity performs and delivers correct rsults
    * turn around
    ...
    * situation/information
        * to describe a situation or information in a way that is intended to influence the way people think about
        * supporeters attempted to spin the bill's defeat to their advantage
    * wool/cotton
    * drive
    * wet clothes
    * insect
* manner
    * way
        * the way in which somethig is done
        * manner of
...
* way
    ...
    * route
        ...
        * can you find your own way out of the builidng?
        * he elbowed/pushed his way to the front of the crowd
        * there's no way through here. you'll have to go round
        * may people have lost their way in the forest
        * only local people could find their way through the maze of narrow street
        * make your way
    ...
    * in a way
        ...
        * In a way, I hope he does'nt win
    * in the way
        * in a position that prevents something from happening or someone from happening
    ...
    * free space
    * want
        * if someone gets or has their way, what they what happens
...
* succeed
    ...
    * achieve something
        * to achieve something that you have been aiming for, or to have the desired results
        * she's been tryng to pass her driving test for yeas and she finally succeeded
        * he succeeded in building the business into one the leaders in its field
        * he is determined to succeed in the property market
        * the new exchange rate succeeded in bringing inflation down
    * follow
    ...
    * succeed as
        * he will succeed him as chief executive
* hook
    * hook up/meet
        * to meet with someone, or to begin a relationship, esp. for a particular purpose
* person
    * in person
...
* amaze
    * to cause someone to be extremly surprised
* astound
    * to surprise and shock someone, eps. with news of something that is completely unexpected
* startle
...
* ceibacy
* obedience
    * when someone does what they are told to do, or what a law, rule etc.sasy they must do
    * obedience to God
...
* obedient
    ...
    * absolute/complete/totla obedience
...
* obey
    * to do what you are told or expected to do according to someone in authority or a rule or law
        ...
        * to obey the rules of international raw
    * to behave according to a scientific principle
        * Falling objects bey the law of gravity 
...
* tan
    * tan line
        * that's not a bathing suit, it's a tan line
    * skin
...
* check
    * check digit
        * a number that is used in a computer program to help to find or prevent error
    * checked off
    ...
    * check on
        * to look at sb or sth in order to make sure that they are safe, correrct, etc.
        * You will need to check on your new employees' qualifications.
    * check out
        * fitting rooms also allow for cashless check out and payment via touchscreen mirrors.
        * leave
            * to leave a hotel after paying for your room and services
            * the gardners checked out early this morning to catch a plane to Tronto
        ...
        * if information, facts, etc. check out, you can prove that they are true or correct
            * if a caller claiming to be from the company asks you for personal data, dial the 800 number on your card to see if his story check out
        * to pay your bill, return your room key, and leave a hotel
            * Please check out before 10 a.m.
        * examine
            * to examine sth or visit a place in order to learn about it
...
* level
    * level off/level out
        ...
        * House prices now seem to be leveling off after the steep rises of the last few years
...
* critical/crucial
    ...
    * Getting this contract is cretical to our success
* lesser of two evils
...
* dependent
    ...
    * the latency goal for AdSense is to avoid slowing down the rendering of the third-party page when inserting contextual ads. the specific latency target, then, is dependent on the speed at which a given publisher's page renders
* petition
...
* pet
    ...
    * make good/ideal pets
        * be good or be very good as pets
...
* reflect
    ...
    * send back
    * return
        * if a surface relects a light, heat, sound, or an image, it sends the light, etc. back and does not absorb it
    ...
    * think
        * to think carefully, esp. about possiblities and opinions
        * the manger demanded time to reflect (on what to do)
...
* dive
    ...
    * quick move
* contrast
    * YouTubne provides a contrasting set of considerations
* remediate
...
* versus
    * consider the difference between intermittent failures that cause profile pictures to fail to render, versus a failure case that results in a user's private contacts being shown to another user
* offset
    * to balance one influence against an opposing influence, so that there is not great difference as a result
        * the extra cost of travelling to wokr is offset by the lower price of houses here
* balance
    * in the balance
    ...
    * stay in position
        ...
        * he balanced the book on top of his coffee cup
    * make things equal
...
* stall
    ...
    * shop
        * a large table or a small shop with an open front from which goods are sold in a public table
        * in the village market, the stalls are piled high with local vegetables
* festival
    * a Jewish/Christan/Hindu festival
    * we've received permission to go ahead with the music festival in spite of opposition from local residents
    * Prepararations for the festival are now proceeding smoothly
    * have/hold a festival
        * Tuscon had a film festival last month
    * celebrate a festival
    * go to a festival/attend a festival
    * appear/play/speak at a festival
...
* gratitude
    ...
    * somebody's eternal/undying gratitude
        * used to emphasize how extremly grateful you are
        * the doctor who saved my daughter have my undying gratitude
    * somebody's deep gratitude/profound gratitude
...
* situation
    * create a situation
        * his arrival created an awkward situation
    * assess/review a situation
        * he was trying to assess the situation objectively
    * monitor a situation
    * the bank is monitoring the situation today
    * deal with a situation
        * he had no idea how to deal with the situation
    * improve/remedy a situation
    * defuse the situation
        * she'd just been trying to clam Gerry down and defuse the situation
    * a situation arises
        * this situation has arisen as a result of serious staff shortage
    * a situation comes about
    * I don't know how this situation has comes about
    * a situation changes
    * the situation could change very rapidly
    * a situation worsens/deteriorate/gets worse
        * reports from the area suggest the situation has worsened
    * difficult/tricky situation
    * impossible situation
    * dangerous situation
    * the presindent/current situation
    ...
    * a social situation
        * a situation in which someone is with other people
    * a work situation
        * a situation at work
    * a no-win situattion
        * one in which there will be a bad result whatever happens
...
* assessment
    ...
    * the process of considering the amount or value of something, or the decision that is made
        * carry out/make an assessment
    * risk assessment
    * self-assessment
    * the process of calculating how much tax someone must pay, or the amount that must be paid
        * tax assessment
    * the process of testing, and making a judgement about , someone's knowledge, ability, skills, etc.
...
* no matter what
    * no matter what happens to the business cycle, people will get continue to eat and get sick
    * no matte what the execuse, make a diva seem a dangerously risky investment
...
* trade
    * buying and selling
    * job
        * a job, eps. one that needs special skills and that involves working with your hands, or the 
        * the building trades
        * he's an auto mechanic/electrician by trade
    * a trade is also any business
        * the book/tourist trade
    * buy and sell
    * these adults simply trades one risk for another
* trading
    * the activity of buying and selling goods and/or service
        * she doesn't approve of Sunday trading
    ...
    * afternoon/early/morning trading
* consecutive
    * consecutive events, numbers, etc. follow one after another without an interruption
        ...
        * coventry city have proved untouchiable this season. the've just won their sixth consecutive game
        * it was United's sixth consecutive win this seasons
    * interest rates have been held at the same level for the tenth consecutive month
    * limited to a maximum of 7 consecutive calandar days
* piecemeal
    * at the moment the system is piecemeal -- some are run by city councils, others are scored by prviate tech platforms which hold personal data
* benigh
    * pleasant and kind; not harmful or severe
        * a benigh smile
    * not likely to result in death
        * a benign tumor
    * person
        * pleasant and kind
    * disease
...
* droop
    ...
    * if prices, sales etc droop, they start to fall
        * In Tokyo, share prices drooped during the Emperor’s illness.
* droopy
    * a droopy moustache
* caress
    * a gentle loving touch or kiss
...
* review
    * think again
        ...
        * he reviews his options before makeing a final decision
    * book/film
...
* represent
    ...
    * describe
        ...
        * to be sign or symbol of something
...
* excite
    ...
    * cause reaction
        * this product has excited a gread deal of media interest
        * the statement excited new speculation that a senior offical may be about to resign
        * she has a mischievous desire to excite my jealousy
    * cause sexual excitement
    * make more active
* mischievous
    * behaving in a way, or describing behaviour, that is slightly but is not intended to cause serious harm or damage
    * she has a mischievous sense of humour
    * a book about the mischievous antics of his ten-year-old daughter
* win
    * to defeat a competitor, or to achieve first position or get a prize in competition
    ...
    * to recieve something positive, such as approval, loyalty or love because you have earned it
...
* skim
    * move above
        ...
        * to throw a flat stone horizontally over water so that it touches and rises off the surfaces several time
        * we watched a child skimming stones across the lake
    * read quickly/ consider quickly
        * to read or consider something quickly in order to understand the main points, without studying it in detail
        * I've only skimmed his letter; I haven't carefully read it yet
        * we've only skimmed the surface of the problem
    * remove
        * strain the cooking liquid and skim off the fat
    * steal
    * skim the market
        * to charge a high price for a new product in order to make as much profit as possible before other similar products become available 
* warm
    * high tenperature
    * frinendly
    * colors
    * grace is a warm, careing woman
* warmness
    * the sate of being warm
* warmth
    * A moderate degree of heat; the sensation of being warm.
    * frindness, kindness, affection
    * the affect of using mostly red and yellow hue
* handson
    * involved
        * someone with a hands-on way of doing things became closely involved in managing and organizing things and in making decisions
        * she's very much a hands-on manager
    * doing
* visa
    * I applied for a visa to visit China
    * get a visa
    * give somebody a visa/grant somebody a visa
...
* chutzpah
    * unusual and shocking behaviour, involving taking risks but not feeling guilty
        * Demonstrate your chutzpah early in the process
...
* supposedly
    ...
    * used when saying what many people say or believe is true, esp. when you disagree with them
...
* flick
    ...
    * move
        ...
        * he flicked the light switch on/off
    * chick flick
        * a film about relationships, love, etc. that attracts mainly women
* epicenter
    * the point on the earth's surface directly above the origin of eathquake
    * an epicenter is also the place that has the highest level of activity
        * We hail from Berlin, the European epicenter of startup culture, and the coolest, most livable city on the planet
...
* hail
    ...
    * call
        ...
        * you wait here with our bags while I hail a tax
    * praise
...
* hoopla
    * game
        ...
        * a game of hoopla
    * busy excitement or a lot of public attention for an event or activity
* skit
...
* fool
    * fool around
        ...
        * not useful
            ...
            * we spent the afternoon fooling around n the beach
...
* appalling
    * very bad
        * appaling weather
        * the drive home was appaling
    * shocking and very bad
        * appaling injuries
* she's too into her looks
    * she's interested in the way she looks (and probably spends a lot of time making sure she looks attractive
* if the worst comes to the worst
    * if the worst thing that can happen does happen
    * if a bad situation becomes even worse:
    * If the worst comes to the worst, we can ask Dad to send us some more money.
* lobbying
    * the activity of trying to persuade someone in authority, usually an elected member of a government, to support laws or rules that gives you organization or industry an advantage
    * lobbying against/for
        * this week, a coalition of unions, religious groups and libera advocacy organizations will officially begin its lobbying for a higher minimum wage
    * extensive/fierce/intence lobbyin
...
* clog
    ...
    * The toilet in this room is clogged!
...
* stereotype
    ...
    * a set idea that peple have about what someone or something is like, esp. an idea that is wrong
        * racial/sexual stereotypes
        * he doesn't conform to the national stereotype of a Frenchman
        * he doesn't fit/fill the national stereotype of a Frenchman
        * the characters in the book are just stereotypes
* pare
    * pare down
        * The answers to key screening questions can allow you to pare down your list and quickly identify the most promising candidates.
    * to cut away the outer layers from something, esp. a fruit or a vegetable
    ...
    * to reduce something, especially by a large amount
        ...
        * Each department should submit plans to pare 2.5% from their budget this fiscal year
* spare
    * save
...
* look
    ...
    * look up sb
        * visit
        * to come and see sb
        * look me up the next time you're in LA
    * look up to sb
...
* incentive
    ...
    * create/give/provide/offer sb an incentive
    * indentive to do
...
* least of all
    * especially not
    * least of all me
    * no one believed her, least of all me
* bonk
    * I won't tell your dad you had ice cream before dinner if you won't tell him about our little bonking incident
* bribery
...
* breezy
    ...
    * informal
        ...
        * she revolutionized faschion reporting with her breezy style
    * happy
...
* bow
    * bow out
        * to git up something, or to decide not to do something that you wre considering doing
...
* retract
    * to say publicly that you will not do something you had said you would do, or to admit that something that you had said was true is false
        * she had to retract her statements in published article
    * to take back an offer or statement, etc. admit that the statement was false
        * retract an invitaiton/confession/promise
    * to retract is also to pull something back or in
        * the pilot retracted the landing gear soon after takeoff
* bonk
    * hit
...
* rush/hurry/dash/hustle/scramble/scurry/hasten/chase/be quick
    * go/do quickly
...
* rally
    * rallying cry/rallying call
        * someting such as a word or phrase, an event, or a belief, which encourages people to unite and to act in support of a particular group or idea
        * an issue that is fast becoming a rallying cry for many Democrats: national health care.
        * And now fast food restaurants are picking up the rallying cry
* compulsive
    * having a very strong desire to do something repeatedly
        * we're not relaly compulsive shoppers, you know
...
* scorn/cotempt
    * contempt
        ...
        * no respect
            * a strong feeling or disliking and having no repsect for sb or sth
        ...
        * hold sb/sth in contempt
            * to feel contempt for sb or sth
        * not obeying
            * contempt of court
...
* book
    ...
    * arrange
        ...
        * sb who books a performer arranges a performance
            * they booked the Rolling Stones for two concerts in New York
...
* appoint
    * person
        ...
        * we've appointed three new teacher this year
        * appoint sb sth
            * she was appointed Chief Executive three years ago
        * appoint sb as sth
            * KPMG were appointed as administrators
        * appoint sb to do sth
            * A commission has just been apointed to investigate fraud claim
    * date
...
* reservation
    ...
    * a feeling of doubt because you do not agree completely with a plan, idea, or suggestion
        * have/express reservations
            * I have serious resevations about his appointment as captain
            * we condemn their actions without reservation
        * some/cetain reservations
...
* rev
    * rev up
        ...
        * The inflammation revs up pigment production
* dermatologist
* dermatology
    * the scientific study of the skin and its diseases
* testimony
    * In his testimony, he denied having commited any crimes
* conspiracy theory
    * the belief that particular events are the result of a secret plan by a group of people
...
* matter
    * situation
        ...
        * to make matters worse
            * used to say that sth has made a bad or difficult situation worse
            * three of our players were ill, and to make matters worse, our main scorer had broken his anckle
        * be a matter of confident/luck/waiting
            * if sth is a matter of confident, luck, waiting, etc. that is all you need for it to happen 
    ...
    * type
        * a substance or things of particular type
        * advertising/matter matter
        * Do you find the subject matter of the book interesting?
    * small amount
        * used in expressions describing how small an amount or period of time
    ...
    * be important
        ...
        * It doesn't matter what you wear -- just as long as you came
        * It didn't matter that our best player was injured after ten minutes -- we still won
* privilege/right
* conceive
* consipracy
* decieve/trick
* foreseeable
    * able to be understood in advance
        * unfotunately, he was unlikely to remain in power for the foreseeable future
        * for a long time, beyond which no one could say what would happen
    * in/for foreseeable future
        * as far into the future as you can imagine or plan for
        * I'll be living here for the freseeable future
...
* foresee
    ...
    * I don't foresee any difficulties so as long as we keep within budget
    * He foresaw the need for cars that would be less polluting.
* vesuvious
* violent
    * spkeaing of volcano, are they a violent igneous rock formation
* igneous rock
* vivisection
...
* cubicle
    ...
    * a small office space that is made by putting up low walls in a larger room
...
* fabricate/manufacture
    * fabricate
        * to invent or produce something false in order to deceive someone
            * to invent a stroy or create a piece of false evidence in order to deceive someone
            * he was late, so fabricated an excuse to avoid trouble
            * he claims that the police fabricated evidencd against him
        * to produce a product, esp. in an industrial process
            * we fabricate locally and ship worldwide
            * the company fabricates and sells steel
            * an electronic circuit is fabricated on a sillicon wafer
* grok/understand
...
* collaborate
    * work with
        * he and he collaborated on a number of successful musicals for the Broadway
    * support an enemy
...
* pawn
    ...
    * to leave a possesion with a pawnbroker, who gives you money for it and can sell it if the money is not paid back within a certain time
        * of all items pawned, jewellery is the most common
    * pawnbroker
        * someone who lend money in exchange for possensions
        * under the law, the owener of an automobile may pawn it to secure a loan up to 2500
* immerse/involve
    ...
    * immerse yourself in sth
        * to become completely involved in sth
...
* rage
    * anger
        ...
        * he sudden towering rages were terrfying
    * event
    ...
    * to happen in a strong or violent way
        ...
        * a flu epidemic is raiging in/through local schools
        * the argument raged on
            * continues strongly
* glacier
    * The glacier reaches halfway down the valley
* melt/dissolve
    * become liquid
        * to turn from sth solid into sth soft or liquid, or to cause sth to do this
        * the snow usually melts by mid March
        * Melt the chocolate slowly so that it doesn't burn
        * the meat's beautifully cooked. it melts in your mouth
    * feel love
        * to start to feel love or sympathy esp. after feeling angry
        * he only has to look at her, and she melts
        * he'd been going to refuse, but his heart melted when he saw the children's face
    * melt away
        * to disappear slowly
    ...
    * melt sth down
    * melt into sth
    * a sandwich containig melted cheese
        * a tuna melt
* famine/hungry/thirsty
...
* appetite
    * food
        * All that walking has given me an appitite
        * I won't have any chocolate, thanks. It will spoil my appitite
        * I haven't got much of appitite
        * the children all have healthy/good appetites
    * need
        * her appitite for adventure
        * his insatiable sexual appetite
* excerpt
    * An excerpt from her new thriller will appera in this weekend's magazine
* whet
    * interest
    * sharpen
    * whet sb's appetite
        ...
        * That one kiss whetted his appetite
...
* transport
    ...
    * feeling
        ...
        * the film transports you back to the NY of the 1950s
* as if/as though
    * it sounds as though she's been really ill
    * he was behaving as though nothing had happened
    * She looked as if she was going to explode
    * Beckworth shock his head as if to say Don't trust her
    * You look as if you're having a good time.
    * As if!
        * He asked if I’d go out with him. As if
            * it is extremely unlikely that I would go out with him
    * the tense after as if is the same tense after wish
...
* segregate/separate
    * to keep one group of people apart from otherse because of race, religion, sex, etc.
...
* underwrite
    * If a bank or other organization underwrites an activity, it gives it financial support and takes responsibility for paying any costs if it fails
        * he underwrote a frind's development company in NY
        * many business have underwritten the event
    * But when a purchase is made using Klarna, the company underwrites the financial risk for retailers until people pay for the goods, either right after checking out or when the product arrives in the mail
* march
    * walk
    * take forcefully
* feast
    ...
    * food
        ...
        * a wedding feast
    * enjoyable thing
        * something that is very enjoable to see, hear, experience, etc.
            * a visual feast
        * a collection of something to be enjoyable
    ...
    * celebration
        ...
        * the Feast of St James/the Passover
        * a Muslim feast day
* drought
    * a long period when there is little or no rain
        * this year severe drought has ruind the crops
* doubt
    ...
    * cast doubt on sth 
        * to make sth seem uncertain
        * Witnesses have cast doubt on the accused's innocent
    * in doubt
        * if the future or success of sb or sth is in doubt, it is unlike to continue or to be successful
        * the future of a stadium is in doubt because of a lack of money
    * without doubt
        * used to emphasize your opinion
        * she is without doubt the best student I have ever taguht
* off the shelf
    * off-the-shelf
...
* evict
    * to force someone to leave a place
        * long-term residents are being evicted from the buildings
        * Tenants who fall behind in their rent risk being evicted
        * he was evicted from the bar for drunken and disordely behaviour
    * evict sb for sth
    * evict sb from sth
    * have sb evicted
* ahead of curve
    * ahead of the game
    * in a opsition where you are more advanced or more successful than your competitors
    * it just shows how desperate New Yorkers are to be ahead of the curve.
* companionship
    * a feeling of friendship
    * we need companionship to stay healthy
* friendship
...
* pivot
    * On the other side, Wonga is retreating from its ambitions to pivot its business (or at least expand it) from loans to payments
* scrutiny/analysing
    * the careful and detailed expression of something in order to get information about it
...
* cater
    * cater for
        ...
        * he has catered functions for up to 200 people
    * a catered lunch
* fashion
* feature
    * to show or advertise sb r sth as the most important or most ovbious part
...
* usage
* aggravate
    * This gets aggravated when you’re interviewing at the top companies like Google, Facebook, Uber, etc.
    * make worse
...
* infringement
    ...
    * even minor infringements of the law will severly punished
    * an infringement claim/lawsuit
    * copyright/patent/trademark infringement
* infringe
    * to break a rule, law, etc.
        * they infringed building regulartions
        * infringe a trademark/patent/copyright
            * the computer giant filed papers claiming that the patent of their online sofwater had been infringed
    * infringe on/upon sth
        * if sth infringes on/upon sb's rights or freedom, it takes away some of their rights or limits their freedom
        * These restrictions infringe upon basic human rights.
* lurch
    * as long as you don’t leave your team in the lurch
* tranquil
    * calm, quit, and peaceful
...
* verdict
    ...
    * reach/return/record a vertect
        * The jury reached/returned a unanimous verdict of (not) guilty
    * deliver/give/issue sb's verdict on
...
* unanimous
    ...
    * unanimous support/approval/agreement/vote/decision/consent
...
* bet
    * place a lay bet
    * to lay a bet
        * to back something not to happen. For example, to lay Manchester United to win their match is to back them NOT to win
...
* through
    ...
    * finished
        ...
        * my girlfrind said we're through
    * during
    ...
    * time
        ...
        * It rained all/right through June and into the fist half of July
* swirl
* pressure point
    * body
...
* globe
    ...
    * the globe
        * the world
        * today we are looking at sites all around the globe for the expansion of our company
* paraphrase
    * Although if you paraphrase the sentence using a literal meaning of "arguably", it may read without any change of the idea
* compulsory
    * that must be done; necessary by law or a rule
    * if something is compulsory, you must do it because of law or a rule
...
* lamp
    * a device for giving light, esp. one with a covering that the light shines through or around
        * a floor lamp
        * a street lamp
...
* ogle
    * to look at someone with ovious sexual interest
    * I saw you ogling the woman in the red dress
* lecherous
    * (esp. of man) showing a strong sexual interest in sb
        * he gave her a lacherous look
    * too insterested in sex
* kindly
    * in a generous, helpful, and caring way
        * They treated me kindly.
    * A kindly person or action is a kind ne
        * a kindly old lady
* kind
    * good
...
* scandalous/shocking/shameful
    * making people shocked or upset
    * scandalous story
* disgraceful
    * very bad
        * disgraceful behaviour/conduct
        * a disgraceful situation
        * she thought that their was absolutely graceful
        * it is graceful that children can get hold of drugs at school
* swirl
...
* snail
    * a small animal that has a shell and moves very slowly
    * at a snail’s pace
* grow
    * increase
        * to increaset in size or amount, to allow or encourage sth to increase in size or to become more advanced or developed
        * the population is growing rapidly
        * grow by
            * the labour force is expected to grow by 2% next year
        * grow from sth to
            * the number of the stores in the town has grown from 80 to 150
        * grow at a rate of sth
            * sales have grown at a rate of 16.2% annually since 2008
        * to grow rapidly/steadly/significantly
    * develop
        * to provide a plant with the condition it needs to develop, or to develop from a seed or small plant
    * become
        * grow tired, old, calm
            * to gradually become tired, old, calm
            * he grew bored of the countryside
            * gwowing old is awful
        * gwow to do sth
            * to gradually start to do sth
...
* eerily
    * her voice was eerily similar to her dead grandmother
    * she heard the eerie noise of the wind howling through the trees
* howdy
    * howdy, stranger
* echo
    * their footsptes echoed eerily
* tailor
    * you just see constant adverts that seem eerily tailored to your interests
* saccarine
    * sugarly
* fluff
    * soft mass
...
* explore/search/discover
    ...
    * travel
    * to think or talk about sth in order to find out more about it
        * let's explore this issue/idea more fully
    * search
        * to look somehwere carefully to find sth
            * Dogs were brought in to search the area for suvivors
...
* toll
    * money
        * an amount of moeney that you have to pay to travel along some main roads, to cross bridges, etc. or to make telephone calls over long distance
        * They’re raising the bridge toll to 5.00 USD.
    ...
    * suffering
        ...
        * in addition to physical destruction caused by the flooding, the emotional toll on its victims was immerse
    ...
    * ring
        * to ring slowly and repeatedly, or to cause a large bell to ring in this way:
    * charge
        * The town hall bell tolled at noon.
* surcharge
    * to charge an extra amount
    * a charge in addition to the usual amount paid for something
        * if you order the tickets by mail, there is a 5.00USD surcharge
* Limousine
    * a luxury vehicle driven by a chauffeur with a partition between the driver's compartment and the passenger compartment
* livery
...
* as of
    ...
    * on a particular date
        * As of August 1, the company had 44 million USD in long-term debt.
* precipitation
    * weather
        ...
        * type of precipitation
            * rain
            * sleet
                * rain freezes before falling to ground
            * hail
...
* dip
    ...
    * drop
        * a part of sth that is at a lower level or movement to a lower level
        * a dip in the road
        * a sudden ip in temperature
    * liquid
        * a cold thick sauce that you eat by dipping pieces of uncooked vegetables or biscuits, etc. into it
        * a quick swim
            * a dip in the sea/pool
        * a special liquid used for cleaning
            * a silver dip
            * sheep dip
    * quick look
    * dip in/dip into
        * to put your hand into a cointainer and take sth out
        * we all dipped into the box of chocolates
        * he dipped his hand in his spokecet and took out a few coins
    * dip into sth
        * book
            * to real small parts of a book or magazine
...
* beam
    * be on your beam ends
        * to be close to complete failure or destruction
        * when we returned to camp we found them on their beam ends, sick and starving
        * the church is on its beam ends and can no longer be relied on as a sponsor f the arts
    * line
        * a line of light that shines from a bright object
            * we could just pick out the trail in the week beam of the flashlight
    ...
    * send out
        * to send out a beam of light, n electrical or radio signal etc.
        * the sun beamed down on the boat as it drifted along
        * the concert was beamed by satellite all over the world
* mesmerize/distract
    * mesmerize
        * to have sb's attention completely so that they cannot think of anything else
            * I was completely mesmeraized by the performance
            * her beautiful voice mesmerized the audience
        * hypotize
    * distract
        * to make sb stop giving their attension to sth
        * Don't distract her from her study
...
* pitch
    * give a pitch/make a pitch for
        * if sb makes a picht for sth, they try to persuade people to do or buy it
        * make a bid to obtain a contract or other business
        * Instead give a pitch
    * throw
        * to throw sth, esp. forcefully
        * she pitched a stone into the river
    * move
        * to move or be moeved suddenly, esp. by throwing or being thrown
        * the bake hit a rut and I was pitched forward onto the road
        * the ship pitched up and down/from side to side in the rough seas
    * level
        * to express or set sth at a particular level
    ...
    * persuade
        * to try to persuade sth to do sth
        * she pitched her idea to me over a business lunch
        * they are pitching for business at the moment
        * it’s probably your first and best chance to pitch the hiring manager on why you’re the right one for the job
    * throw baseball
        * to throw a baseball toward a player from the opposing team who tried to hit it with a baseball bat
    * fall
        * to fall suddenly
        * the bus stopped suddenly, pitching everyone forward
    * raise
        * to raise a tent and fix it in place
...
* videotape
    * I cannot believe you thought you were going to videotape us having sex on the first date
* drool
    * to have some saliva come out of the mouth
        * The baby drools and laughs, and it makes me happy.
    * to drool is also to show great interest and pleasure
...
* shrewd/astute
    * shrewd
        ...
        * shrewd move
    * astute
        * able to understand situation quickly and see how to take advantage of it
        * an astute investor/businesswoman
        * his astute handling of the situation
* steer
...
* colonize
    * I do not support the idea of colonizing other planets
* welcome
    * encourage
        * to be pleased about and encourage or support sth
        * the new appointment has been widely welcomed
    * support
        * to be pleased about or support sth
            * baseball fan's welcomed the end of the player's strike
    ...
    * meet
        ...
        * He stood at the door, welcoming newcommers with a large smile and a pat on the arm
        * Please welcome our guest of hounour
            * please clap for
    * supported
        * you're welcome
    * met
        * received in a friendly way
        * you'll always be welcome here
    * pleased
        * be welcome to do sth
            * used to tell sb that they can certainly do sth
            * Anyone who is interested in is welcome to come along
* curate
    * to be in charge of selecting and careing for objects to be shown in a museum or to form part of a collection of art, an exhibition
    ...
    * to select things such as documents, music, products, or internet contents to be included as part of a list of a collection, or on a website
        * a curated library for short movies availbale online
* pat
...
* jealous
    * wanting qualities
        * unhappy and slightly angry because you wish you had sb else's qualites, advantages or success,
        * Ron was jealous of his colleague's promotion
    * fearful about love
        * fearing that sb you love loves sb else or is loved by sb else
        * very careful to protect sb or sth
    * careful to protect
    * unhappy
        * a jealous husband/wife
        * unhappy and angry because sb has sth that you want
...
* outsource
* That's good to know
    * I'm happy to be aware of that!
    * That's useful to know!
* That’s very kind of you.
    * It's very kind of you to help us
    * How nice of you! What a lovely thing to say or do!
    * That new haircut makes you look 10 years younger Barbara. -That's very kind of you
* wrench
    * twist
        * to pull and twist sth suddenly or violently away from a fixed position
            * the ball was wrenched from his hands by another player
            * the photographer tripeed over the crowd, wrenching a microphone from its stand
            * the phone had been wrenched from/off the wall
            * the ball was wrenched out of his grasp by another player
        * if you wrench part of your body, such as your arm or knee, you twist it badly and ijure it
            * he wrenched his back while digging in the garden
        * to suddenly take sb from people they love, causing them great unhapiness
...
* deliverable
    * sth that can be provided or achieved as a result of a process
        * what are the project deliverables?
        * we were told that our deliverables -- our memos, reports, and newsletter -- needed to adopt the look and feel of the network
        * we need to a schedule for the dates when the major deliverables should be available
...
* hand
    * hand over
    * have the upper hand
        * This team has the upper hand over their opponents because of their better training.
* articulate
    * expressing or able to express things easily and clearly
        * an intelligent and highly articulate young woman
    * to explain in words, esp. to express sth clearly
        * She gave a witty, entertaining, and articulate speech.
    * form a join
        * to connect two bones by forming a joint
* atrocity
    * an extremly cruel act, or the commitng of such acts
    * the commission reports that atrocities were commited by all sides during the struggle
    * the fact of sth being extremely cruel, violent, or shocking
    * these people are guilty of acts of applaing atrocity
* sentient
...
* eloquent
    * using langugage to express ideas or opinions clearly and well, so that they have a strong effect on others
...
* reiterate
    * to say something again, once or several time
    * he reitereated his view that it was time to withdraw from the region
* remformulate
* relinquish
    * to give up sth, such a responsiblity or claim
        * he reufsed to relinquish control of his company
        * she relinquished control of the family investments to her son
    * to unwillingly stop holding or keeping sth
        * She relinquished her hold/grip on the steering wheel.
* admission
    * permission to enter
        * the act of agreeing that sth is true, esp. unwilingly
        * Her silence was taken as an admission of guilt/defeat
    * statement
        * I felt he would see my giving up now as an admission that I was rong
    * accepting
    * allowing in
        * the money that you pay to enter a place
            * how much do they charge for admissions?
            * the admission charge/fee is 5euro
        * permissions to enter a place
* coumpoud question
    ...
    * Double-sided question
        * in many cases, to catch the candidate off guard
* fallacy
* advice
    * advice about
    * advice about/on
...
* out of the blue
* gravity
    * Why do you gravitate towards it?
* proactive
* self-starter
* diplomatic
...
* refreshing
    * bringing new energy and strength in a pleasant and often unexpected way
        ...
        * it's refreshing to see so many young families moving into the neighborhood
    * making you feel less hot or tired
        * there's nothing more refreshing on hot day than a cold beer
...
* relish/enjoy
    * enjoy
        ...
        * I enjoyed our vacation, but didn't relish the twenth-hours trip back home
    * sauce
    * enjoyment
        * the enjoyment you get from doing sth
    * I relish the challenge of rebuilding the club.
* challenge
    * something difficult
        * sth that tests strength, skill or ability, esp. in a way that in interesting
        * challenge of
        * the challenge of doing sth
        * face/take on/accept a challenge
            * be ready to deal with one
        * meet a challenge/ rise to a challge
    ...
    * question something
        * when sb refuses to accept that sb or sth is right and legal
        * challenge to
        * challenge from
        * pose/represent/present a challenge
        * mount/launch challenge
    * competition
    * stop
    * in law
* equation
    * complex situation
        ...
        * managing the economy is a complex situation of controlling inflation and reducing unemployment
    * statemnt
    * same
...
* nerve-wracking
    * is a widely-used and well-established variant spelling
...
* rack
    ...
    * frame
        ...
        * a towel rack
    * cause pain
        * to cause sb great physical or mental pain
        * even near the end, when cancer rakced his body, he remained hopeful
...
* homogeneous
    * of the same kind or type; alike
    * Japan is known for being a homogeneous society
* workforce
    * the Japanese government encouraged retired workers to re-enter the workforce and supported the use of artificial intelligence in many industries
        * the group of people who work in a company, industry, country
        * the majority of factories in the region have a workforce of 50 to 100
        * much of the workfoce in the banking sector is affected by the new legislation
        * the workforce was laid off
...
* emigrate
    * to leave a country permanently and go to live in another one
        ...
        * Thousands of Britons emigrate every yera
        * Opportunities to emigrate to the U.S. have been severly cut back by tightened immigration rules and border controls
* immigrate
...
* migration
    * movement from one region to another and often back again, esp. according to the season of the year
        * It doesn't have to be a permanent move, but migrate is more than a weekend away, and it's not just for butterflies
...
* exempt
    ...
    * with special permission not to do or pay sth
        * be exempt from sth
...
* scan
    ...
    * if an image or text on paper is scanned into a comptuer , it is cahnged into electric information by a special device
    * if you scan a text you read it quickly
        * I scanned a few pages of the book and thought it looked interesting
    * look
    * make picture
    * poem
    * he act of looking at or through something carefully or quickly
        * A quick scan of my calendar shows that I'm pretty busy this week
        * a security scan of passengers’ bags
    * to use a piece of electronic equipment to get information from sth such as bank card or a product's barcode
    * a quick look through something, especially in order to check that it is good enough
...
* convict
    ...
    * to decided officially in a court of law that sb is guilty of a particular crime
        * There might not have been enought evidence to convict him
        * someone who has been judged guilty of a crime and is in prison as a result
        * He has twice been convicted of robbery/arson.
    * sb who is in prision because they are guilty of a crime
        * an escaped convict
* acquit
* exculpate
* exonerate
...
* intercourse
    * the sexual activity in which the make's penis enters the female's vagina
    * sex
...
* connotation
    ...
    * it carries the connotation that what was previously not so scary has gotten so -- the situation has gotten worse
* accost
...
* per se
    * by or of itself
    * It is not pretty town per se, but it is where my family comes from, so I like it
...
* overtime
    ...
    * a period of 
    * Any overtime shall be paid as agreed remuneration
* cue
    * signal
...
* confine
    ...
    * if sth is confined to a particular group of people, it exists only among them
    * Cancer is not confined to old people
    * to keep sb or sth within limits
...
* oil painting
* opt
    * to make a choice, esp. for one thing or possiblity in preference to any others
        * I opted for 100 trees
    ...
    * opt-in
        ...
        * It is an opt-in rather than an opt-out system, which means that permission must be sought on a case-by-case basis.
    * opt out
    ...
    * opt-out
        ...
        * opt-out feature/policy/process 
* appreciable
    * (esp. of amounts or changes) large enough to be noticed or to have an effect
    * if an amount or change is appreciable, it is large or noticiable enough to have an important effect
        * there has been an appreciate drop in the number of unemployed since the new government came to power
* headrush
* ick
* icky
    * It's icky
...
* bum
    ...
    * bum out
        ...
        * You bummed him out
* hobo
    * a person who does not have a job or a house to live in, and so moves from one place to another
* tramp
    * you tramp
    * walk
    * poor person
    ...
    * poor person
    * to walk, esp. long distance or with heavy steps
...
* roam
    ...
    * to move about or travel, esp. without a clear idea of what you are going to do
        * After the bars close, gangs of youths roams the city streets
    * We have little robots that roam the sidewalk and deliver food to your neighborhood
* trudge
    * 
* lamppost
    * Kiwi robots has six cameras and sensors to stop them from hitting cars, lamppost, and poeple's feet
* menstrual
    * connected with the time when a woman menstruates
    * the menstrual cycle
    * menstrual pain
    * a woman's period
* menstruate
    * to have a flow of blood from the uterus, usually for three to five days every four weeks, in women who are not pregnant
* menstruation
* mense
    * menstruation
    * our menses are synchronized
* premenstrual
    * of the time just before a woman’s period
* primate
    * female primates
* chimpanzee
* burrito
...
* contraindicated
    ...
    * used to say that a drug or treatment should be used in a particular situation as it is likely to harm the patient
    * Most X-rays are contraindicated in pregnancy.
* off the topic
...
* digress
    ...
    * But I digress. To get backto what I was saying, this poem reflects the poet's love of nature and his religous belief
    * the lecturer templarily digressed from her subejct to deal with a related theory
* bail
    * he bailed out a medical school
* bold
    * that's bold
* act
    * behave
    ...
    * perform
        * a circus act
        * his story is just an act
    * law
* crave
    * to desire sth strongly
    * The neglected kids just crave attention.
* far-right
* slow things down
* homogenous
    * The country is one of the least homogenous societies in the world
* coordinate
    * The countries are taking steps to coordinate their military actions in Syria.
...
* centripetal force
* harass
    * He claims to have been harassed by the police.
* recruitment
    * recruitment process
* completion
    * on completion
...
* hire
    ...
    * to pay to use sth for a short period
    ...
    * to employ sb or pay sb to do a particular job
        * I was hired by the first company I applied to.
    * thing
        * an arrangement to use sth by paying for it
        * the price includes flight and car hire
        * a hire car
    * person
    * hire sth/sb out
        * to allow sb to use sth or sb temporarily in exchange for money
...
* gloss
    * shine
    * epxlanation
        * an explanation of a word or phrase in a text
            * difficult expressions are explained in the glosses at the bottom of the page
    * appearance
        * a smooth, shiny appearance on the surface of sth
        * paint that produces a smooth, shiny apperance on a surface
    * explain
...
* courtesy
    * polite behavior, or a polite action or remark
        ...
        * As a courtesy, we will email you if there is any change to these arrangement
    * by courtesy of/courtesy of
        * with the permisson of sb
            * Photo courtesy of Department of Transportation and Public Facilities
        * because of, or provided by, sb or sth
            * dealers were not exicited about the market's performance, nothing that the strong gains came courtesy of a handful of stocks
            * the offer comes to you courtesy of the One World travel company
    * provided at no cost
        * there is a courtesy bus provided to take you to the terminal
        * AA Insurance now offers a courtesy car untial all claims are settled
* repent
    * I have repented for my preparation for the competition
    * to be sorry you did or did not do something:
    * to be very sorry for sth bat you have done in the past and wish that you had not done it
...
* blow up doll
* inmate
    * the inmates were very angry about the conditions in the prison
* bumber-to-bumber
...
* extinct
    * go extinct
* existential
    * Global warming poses an existential threat to many Pacific Island nations.
* deploy
    * The soldiers are being deployed by parachute
* catastrophe
    * Destruction of rainforests is a catastropphe for the entire world
* displacement
    * Famine has led to the displacement of thousands of people
* antibiotic resistance
    * Antibiotic resistance is mainly caused by the overuse of antibiotic medicines.
* obstracle
* terrain
* motorcycle
* motorbike
* overtake
    * go past
        * to go beyond sth by being a greater amount or degree, or to come from beyond
...
* while
    ...
    * during
* traffic
    * I'm stuck in traffic, so I can't make it to the lesson on time
    * I got caught in traffic, so I can't make it to the lesson on time
    * heavy traffic
    ...
    * traffic moves/flows
    * traffic is diverted
    * motorway traffic/freeway traffic
    * oncomin traffic
* jammed
    * traffic jam
* taddy field
...
* comprehend
    ...
    * if you don't comprehend sth, don't be afraid to seem dumb, just speak out
    * I fail to comprehend their attiude
* loose
    * not attached
    * not tight
* loosely coupled
...
* aphorism
    ...
    * Indeed, it is a common aphorism in statistics that "all models are wrong"; hence the "true model" (i.e. reality) cannot be in the candidate set
* brand
    * product
        * a type of product made by a particualr company
        * this isn't my usual brand of deodrand
    * mark
    * judge
        ...
        * domestic/international/global branhds
        * premium/luxury/quality brands
    * flame
    * Brand-building is hard, time-consuming work
    * To build a strong brand, you must create products and services that customers love, and then devise an easily recognizable brand image that epitomizes and reinforces that emotion.
* epitomizes
* toot
    * to make a short sound or series of short sounds, esp. with the horn of a car as a warning
...
* underdeliver
* frustrates
    * Nothing frustrates customers more than being promised something and then not getting it.
* underpromise
* overdeliver
* damage
    ...
    * harm or injury
* grungy
    * feeling dirty and that you need to wash, or (of a thing) dirty
    * it's also not simply equivalent to administrative chores or grungy work
* adulation
...
* ponder
    ...
    * she ponders the relation she'll receive
    * She sat back for a minute to ponder her next move in the game.
* ersatz
    * used instead of sth else, usually because the other thing is too expensive or rare
    * I'm allowed to eat ersatz chocolate made from carob beans, but it's poor substitute for the real thing
...
* inflammation
    * This cream will help reduce the inflammation on your skin.
* tissue
    * muscle tissue is about 15% more dense than fat
* voltage
    * The area is surrounded by an electric fence of high voltage.
* a fish out of water
    * I feel like a fish out of water at my new school
* hold your horses
    * they’re asking you to slow down or wait a moment
...
* crowd
    ...
    * a crowd is also a group of friends
    * to fill a place
...
* atypical
    * not typcail, different from most others of its type
...
* aneurysm
    ...
    * brain aneurysm
    * a big brain aneurysm I've been hoping for
* matchmaker
    * Am I matchmaker or what?
* congested
    * too crowded or blocked
        * congested airspace
        * london's roads are heavily congested
        * congested airports
    * sb who is congested has a blocked nose and cannot breathe through it, usually beacause of a cold
* downtrend
    * the latest figures suggest a downtrend in unemployment
    * the newspaper business has been in a long-term downtrend streching back to the 1940s
* zinger
...
* truth or date
    * Players are given the choice between answering a question truthfully, or performing a "dare", both of which are set by the other players. Players must perform the dare they are given, or answer the question asked, quiting the game to avoid a dare or question is not allowed, or switching the choice with the other.
* possible explations for your symptoms are in descending order of likelihood, 
* they're onto me
    * They suspect and are keeping an eye on me
* hysterical
...
* pinworm
    ...
    * They are about one-half inch long.
    * While the infected person sleeps, female pinworms leave the intestinal tract and lay their eggs on the skin around the anus.
...
* deterrent
    * Security cameras have a deterrent effect on crime.
* annexation
    * Russia's annexation of Crimea took place in 2014.
* denture
* bob
    * to move up and down quickly and gently, especially on the surface of wate
    ...
    * Bob's your uncle
        * used to mean that sth will happen very quickly and simply
        * Just tell them yor're a frined of mine, Bob's your uncle, you'll get the job
* Christianity
    * the Christian faith, a religion based on the belief in one God and on the teaching of Jesus Christ, as set forth in the Bible
...
* spirited
    ...
    * the home tema's spirited playing ensured them a comfortable victory
* status quo
    * They have openly expressed their discontent with the political status quo in the country.
* petition
    * We're collecting signatures for this petition against companies polluting the environment
* metaphorical
    * I struggled to understand his speech, as it was full of metaphorical expressions.
* discretion
    * Teachers may use their own discretion when marking the exam.
    * choice, or the right to make a choice, based on judgment
    * careful behaviour
        * the ability to behave without causing embarrassment or attractin too much attention, esp. by keeping information secret
        * Can you trust him with this? Yes, he's the soul of discretion
    * right to choose
        * the right or ability to decide sth
        * students can be expelled at the discretion of principal
...
* Moat
    * economic moat
        * an economic moat is a competitive advantage that one company has over other companies in the same industry
* overdue
    * not done or happening when expected or when needed; late
    * she feels she's overdue for a promotion
    * My library books are a week overdue.
    * not paid on time
        * overdue payment/fee/bill
        * overdue loan/debt
...
* garner
* vigorous
    * After a vigorous hike, I got really thirsty
...
* warrant
* compatible
    * This software is compatible with Mac and Windows.
* biometrics
* team
    * Mastercard and Marie Claire magazine have teamed up to create “The Next Big Thing” concept shop, a pop-up store that brings the convenience of online shopping to a physical storefront.
* storefront
* passerby
    * plural: passersby
...
* sign
    * sign in
        ...
        * to sign your name in a book when you arrive at an office, hotel, etc. to show that you have arrived and are in the building
            * remember to sign in when you arrive at the conference
    * sign off
* kick
    * kick off
        * to begin
        * start
            ...
            * the advertising campaing is just about ready to kick off
...
* differentiate
    * the simplest way to differentiate between a slow avereage and a very slow tail of request is to collect reuqest counts bucketed by latencies
* differentiator
...
* insouciance
    * a relaxed and happy way of behaving withtout feeling worried of guilty
...
* refuge
    ...
    * Residnets took refuge in their basements during the tomato
...
* bogus
    * (of sth) not what it appears or claims to be; false but made to look real
    * he was arrested charged with carrying a bogus passport
...
* phoney
    ...
    * sb who is not sincere or not what they claim to be
* pseud
    * a person who tries to seem to have detailed knowledge or excellent judgement of a subject, esp. in art, literature, musci, etc.
* pretend
* fraud
* brag
* bureau
    * department
        * a department of goverment, or division that performs a particular job
    * furniture
        * a chest of drawer
    * organization
* bureaucrat
    ...
    * sb working in bureaucracy
    * carerer/federal/government bureaucrats
* bureaucratic
    * involving long and difficult dealings with officials
        * Bureaucratic bungling is the most likely explanation for thing going wrong
...
* bungle
    ...
    * to do sth wrong, in a careless or stupid way
* botch
    * to spoil sth by doing it badly
    * he thinks the police botched the investigation
    * we boched up our first attempt at wallpapering the bathroom
    * sth that is spoiled by being done badly
* spoil
    * destroy
        * to destroy or damage sth, or to become destroyed or damaged
            * the oil spill spoiled five miles of coatline
    ...
    * profits
* ruin
    * to spil or destroy sth
    * to cause a person or company 
* foul
    * foul-up
    * unpleasant
        * extremly unpleasant
    ...
    * make dirty
        * to pollute sth or make it dirty
            * the oil slick fouled the Califronia coasrtline
    * sports
...
* fail
* pushy
    * trying too hard to persuade someone to do something
    * a pushy salesman
* submissive
    * showing a willingness to be controlled by other people
    * a submissive gesture
...
* far right
    * the extreme right wing of political party or group
...
* viable
    * able to exist, perform as indeed, or succeed
...
* lively
    ...
    * comparative
        * livier
        * more lively
    * having or showing a lot of energy and enthusiasm, or showing interesting and exciting throught
    * We have a lively group of seniors who meet to discuss the books they’ve read.
    * (of clours) bright and strong
        * the room was painted a lively electric blue
* concordant
    * in agreement with other facts or based on the same principles as sth else
...
* supplement
    * saturation can be supplemented with higher-level load measurement
    * to add to sth
    * He supplements his income by working in a bar at night
    * Some vegetarians like to supplement their diets with iron.
* tempt
    * it's tempting to design a system based upon the mean of some quantity
* resolute
...
* resolution
    ...
    * decision
        ...
        * I made a New Year’s resolution to lose ten pounds.
...
* character
    * in character
        * in keeping with sb's usual pattern of behavior
    * out of character
        * not in keeping with sb's usual pattern of behavior
* prebake
    * to bake in advance or beforehand
    * to bake partially before final cooking, as a pie shell is partially baked prior to adding the filling to prevent it going soggy
* endorse
    * support
        * to make a public statement of your approval or support for sth or sb
        * I fully endorse (= agree with) everything the Chairperson has said.
        * That's widely endorsed and followed within Google SRE teams
    * sign
    * give permission
    * punish
* imminent
...
* impending
    * (of sth unpleasant) about to happen soon
    ...
    * saturation is also concerned with predictions of impending saturation
* dissipate
    * to disapprea gradually, or to cause sth to disappear gradually
...
* voluminous
    ...
    * A voluminous piece of writing is long and detailed
        * Have you read his voluminous account of his life?
* voluminously
* triage
...
* pronged
    * A two/three-pronged plan involves two/three different ways of achieving the same aim
        * the team used a three-pronged approach
...
* retrofit
    * to provide a machine with a part, or a place with equipment, that it did not originally have when it was built
        * We're retrofitting these plants with state-of-the-art emission controls.
    * an occasion when a machine or place is retrofitted
        * Many hospitals are struggling to pay for the retrofits
* mistrust
    * to have doubts about the honesty of sb be unable to trust sth
    * I'm always mistrusted leaders who make too many promises
* sedentary
    * Research suggests that having a sedentary lifestyle can be worse for your health than smoking.
* offspring
    * The word for the offspring of a cat is "kitten".
* misunderstand
    * to fail to understand something or someone
    * I think she misunderstood what I meant.
* warhead
    * the end of a bomb or missile that contains explosives
    * a conventional/nuclear warhead
* inconceivable
    * unblievable
* hubris
    * an extreme and unreasoble feeling of pride and confidence in yourself
    * Hubris brought him down in the end
    * a way of talking or behaving that is too proud
    * he was punished for his hubris
* ordain
    * church
        * to officially make sb a priest or other religious leader, in a religious ceremony
    * order
        * to order sth to happen
        * there is a strong support here for the tough economic reforms ordained in the federal capital, Prague
        * I don't know who came up with the idea, but the city council has ordained that all the local libraries will close on Mondays.
* lend
    * lend a hand
        * He went over to see if he could lend a hand.
* self-made
...
* impulse
    * desire
        * a sudden, strong desire to do sth
            * I had this impulse to dye my hair
        * if you do sth on impulse, you do it because you suddenly want to
...
* puffery
    ...
    * His book avoids academic puffery and offers real insight.
* animalistic
* homo habilis
    * A Homo habilis discvoering his opposable thumbs says, what
* opposable thumbs
    * They are called opposable because the thumb can be moved around to touch the other fingers, which gives people the ability to grasp things.
* succumb
    * we might succumb to cannibalism
    * to lose the determination to oppose sth, or to give up and accept sth that you first opposed
    * if you succumb to an illiness, you die from it
    * succumb to
        * The company succumbed to a 41bn dollars  bid from its arch rival.
* cannibalism
* chew
    * chew off
* flesh
...
* wind
    ...
    * wrap around
        * wind/wound/wound
        * to wrap sth around an object several times or twist it repeatedly around itself
...
* meantime
    * in the meantime
* comatose
    * when I'm lying comatose in a hospital relying on inferior minds to cure me, these cultures and my accomanying notes will give them a fighting chance
* fluid
    * Fluids are liquids that you drink
    * I need to measure my fluid intake and output to make sure my kidnesy aren't shutting down
* intake
    * the amount of sth such as food, breath, or a liquid that is taken in by sth or sb
...
* postpubescent
    * post pubescent
    * postpubescent Asian wunderkind
    * of, relating to, or occurring in the period after puberty
    * having been through puberty
* wunderkind
    * a person who is very clever or good at something and achieves success at a young age
    * the wunderkind of Goldman Sachs
    * The 37-year-old retail wunderkind regularly receives job offers to head some of Britain's biggest companies.
* vertigo
...
* elude
    ...
    * if sth is eludes you, you do not succeed in achieving it
        * it was simply her misfortune that an Olympic medal eluded her in 1988
    * not achieve
        * if sth that you want eludes you, you do not succeed in achieving it
        * the gold medal continues to elude her
        * they had minor breakthroughs but real success eluded them
    * not be caught
        * to not be caught by sb
        * they eluded the police by fleeing
    * not remember
        * If a piece of information eludes you, you cannot remember it
        * I know how you mean but her name eludes me
* elusive
* nugatory
    * worth nothing or little value
    * a nugatory amount
* hypocrite
    * sb who says they have particular moral beliefs but behaves in way that shows these are not sincere
...
* swindle
    * to get money dishonestly from sb by deceiving or cheating them
...
* con
    ...
    * sth done to trick or deceive sb
        * a con game/job
    * trick
    * disadvantage
* gyp
...
* away from
    * We can use away from to refer to movemenjV>
    ...
    * We’re now in Rome. How far away from Rome is Naples? 
* thy will be done
    * is the third of the seven petitions in the Lord's prayer (the first three address God, the second four are prayers related to our needs and concerns).
* gurney
    *  wheeled stretcher used for transporting hospital patients.
* comtemptible
* objectionable
* scumbag
* mingle
    * mix
        * to mix with; combine;
        * her excitement at staring the new job was mingled with fear
        * The excitement of starting a new job is always mingled with a certain apprehension.
    * be with
        * he seems to be mingling with the other guest
* apprehension
    * worry
        * anxiety about the future; fear of sth unpleasant happening
    * taking hold
        * the act of catching and putting a person under police control
        * there's an 8000 dollars reward for the apprehension of the prepetrator
    * catching
    * understanding
* apprehend
    * to catch and put a person under police control; arrest
        * the police have finally apprehended the killer
    * understand
        * to understand sth
* prepetrator
    * sb who has committed a crime or a violent or harmful act
    * the prepetrator of the massacre must be brought to justice as war criminals
* massacre
    ...
    * to defeat opponent very badly in a competition or election
...
* literate
    ...
    * a literate person
    * Are you surprised there are 780 million non-literate people in the world?
* illiteracy
    * the inability to read or write
    * a lack of knowledge about a particular subject
* fly
    * travel through air
        * to move through the air, or (of people) to travel by aircraft
            *  Are you planning to fly or drive to Toronto?
    * move quickly
    * wave
    * insect
    * pants
...
* chink
    * crack
    * sound
    * to make a alight ringing sound
* Chink
...
* sack
    ...
    * job
        * the sack
            * a situation in which you are told by your employer that you must leave your job, esp. because you have done sth wrong
            * get the sack
            * give sb the sack
            * face the sack
            * earn sb the sack
...
* discount
    * a reduction in the usual price for sth
    * Students receive a 10 percent discount
    * he gets a senior citizen discount at the theater
    * not consider
        * to decide that sth or sb is not worth consdieration or attention
        * he discoutned fears about computer programming problems involving the year 2000s as exaggerated
    * reduce price
* conform
    * conform to
* criterion
...
* commit
    * promise
        * to promise to give yourself, your money, your time, etc. to support sth
            * they wouldn't commit enough time or money to the project
    * put
        * to actively put informatin in your memory or write it down
    ...
    * send for treatment
        * to cause sb to stay in a mental hospital or treatment center
        * he was once committed to a state mental hospital
* commitment
    * a promise to give yourself, your money, your time, etc. to support or buy sth
...
* fuzzy
* fuzz
    * light, loose hairs on fibers, or a covering or mass of these
    * hair
...
* lay
    ...
    * layoff
        * an act of ending a worker’s job, esp. when the worker has done nothing wrong
            ...
            * the recent economic crisi has led to massive layoff
        * work
        * football
* inauguration
...
* extent
    ...
    * to the same extent
        * to the same degreee as; as much as
    ...
    * to such an extent
        * so much
        * the car was damaged to such an extent that it coulnd't be repared
    * to what extent?
...
* scatter
* disseminate
    * The tax cut was given to spur consumer spending.
    * to spread or give out news, informatin, ideas, etc. to many people
...
* probation
    * Afater the probation period expired, 
* the priod of employement shall end without notice of termination being required
* probationary
    * probationary period
    * the first 3 months shall be considred as probationary period
* notice
    * notice period
...
* perfunctory
    * done quickly and without showing that you care or have much interest
        * his smile was perfuctory
* cursory
    * quick and probably not detailed
    * a cursory glance/look
    * a cursory examination
* archaic
    * I believe that reference checks are an archaic practice being continued as part of 'tradition' especially by HR personnel coming from a non tech background.
* numb nuts
* pointless
...
* compassion
    * a strong feeling of a sympathy and sadness for other people's suffering or bad luck and a desire to help
    ...
    * with compassion
        * He explores this senstive topic with compassion
...
* diabolical
    ...
    * very evil but often intelligent
        * a diabolical genius
...
* phlegm
    * a thick, liquid substance produced in the throat and nose esp. when you have a cold
...
* mucus
    ...
    * mucus throat
    * Mucus membranes
        * Mucus membranes make phlegm to protect and support your respiratory system
...
* miscible
    * of a liquid, able to be mixed into another liquid without separating from it
...
* springboard
    ...
    * something that is a basis from which other things grow or develop
        * a springboard for/to/into sth
            * Manufacturing facilities abroad could be a springboard for our expansion in a market
        * a springboard to do sth 
            * They intend to use the £150 million acquisition as a springboard to buy other food brands.
* humidifier
    * run the humidifier
    * If the air in your house is dry, a  mist humidifier or vaporizer can moisten it to ease congestion and coughs. 
* earaches
* drainage
...
* fussinness
* conscientiously
    * the employee must perform all duties carefully and conscientiously, taking into account the instructions of supervisors and the interestes of the Company
* precedent
* Conflict of Interes
...
* remuneration
    ...
    * they demanded adequeate remuneration for their work
    ...
    * annual/total remuneration The deal took his total remuneration last year to £2.4m.
* contagious
    * a contagious disease can be caught by touching sb who has the disease or a piece of infected clothing
...
* statutory
    * decide or controlled by law
    * satutory obligations
    * statutory duty/obligations/responsibilities
* deduction
    * the process of learning sth by considering a general set of facts and thinking about how sth specific related to them
    * an amount of part taken away from a total, esp. an expense that you do not have to pay taxes on, or the process of taking away an amount or part
    * New tax regulations would cut the deduction for business lunches
    * the interest I receved on my savings account is paid after the deduction of tax
...
* proviso
    ...
    * a part of a legal document that states that sth must happen or be done
...
* consent
    ...
    * with/wihtout sb's consentn
        * your temrs of employment cannot be changed without your consent
    * written/prior consent
        * for certain types of business purchase, you may require the prior consent of an industry regulatory
...
* demonstrably
    * able to be prove or shown
        * Mr. Ambrose, to be credible, needed some demonstrable facts.
* reimburse
    * to give back the amount of money that sb has spent
    * they're going to reimburse me for the airfare
    * the airline reimbursed me for the amount they had overchaged me
...
* accrue
    * to incease over a preriod of time, or to get an amount to get an amount of sth gradually over time
...
* honorary
    ...
    * an honorary position in an organization is one for which no payment is made
        * Charities often have a well-known person as their honorary treasuer
    * given to sb in order to show respect for their achievements rather than through study, payment, etc.
...
* post
    ...
    * results
* withdraw
    * to take sth back or to remove sth
    * remove
    * stop contact
        * to stop talking to other people and start thiking thoughts that are not related to what is happeing around you
    * to take money out of account
    * to stop selling a product or offering a service, usually because of a problem or fault
    * to remove sth that you previously agreed to provide
    * to stop being involved in a situation, having a particular responsibility, or belonging to an organization
    * to tell people officially that something you said earlier is not true or correct
* forbidden
    * The Employee is further forbidden from establishing, acquiring, or directly or indirectly holding shares in such a company for the term of this Employment Agreement
    * not allowed, esp. by law
        *  smoking is forbidden in the cinema
    * not permitted, es;. by rule or law
        * Automobiles are forbidden on the island
        * he was strictly forbidden to talk with them
    * forbidden fruit
        * sth, esp. sth sexual, that is even more attractive because it is not allowed
...
* fitness
    * the quality of being suitable for sb or sth
    * the condition of being physically strong and healthy
    * health
    * suitable quality
        * his fitness for the new position s not in question
        * many people are concerned about her fitness to govern
    * They have to pass exams to test their fitness for the job.
    * Doctors will remains on the medical register only if they can demonstrate their fitness to continue practising
* clunky
    * solid
...
* vertical
    ...
    * business
        * vertical market
        * a market consisting of businesses that supply products and services each other
        * their strategy is to focus on software and services for vertical markets
        * tech verticals
    * a vertical line, etc. goes straight up or down rather than accross
    ...
    * used to describe the different srtages of an industrial or commercial process, and the organization involved
        * vertical agreement/market/restraint
* glacial
    * not frinedly
    ...
    * ice/cold
        * made or left by a glacier
            * glacial deposits
        * extremly cold
            * glacial temparatures
            * a glacial period
* post-contractual
* non-competition clause
* the non-competition clause shall not exceed a maximum duration of one year
* lapse
    * failure
        * a failure to do sth that happens as a particular event at a particular time
        * a memory lapse
    * period
        * a period of time after an event or between two events
    * end
        * to end sth, either intentionally and accidentally, that might be continued or that should continue
        * I must have let my subscription lapse, because I haven't received any issures of the magazine in months
* supersede
    ...
    * if a process, system, or product supersedes another, it replaces it because it is more modern or becomes more popular
        ...
        * be superceded by sth
            * Phones using 2.5G technolgy were superseded by third-generation 3G phones
* marital
    * marital status
...
* the agreement is subject to Japanese law. The language of the Agreement is Japanese. The English translation is for information purposes only and has no legal status* affiliate
    * The Company is an affiliate of Super Bank (hereinafter Super )
* inter alia
    * among other things
...
* assign
    * Employee is assigned to perform on-call service
* supervisor
* thereof
...
* notebook
    * laptop
* equate
    * Christmas Eve and New Year’s Eve are equated with public holidays
* addendum
    * plural: addenda
...
* supplement
* postscript
* unless otherwise stated explicitly in this agreement
* indispensable
    * too important not to have; necessary:
    * none of our player is indispensable
    * sth or sb that is indispensable is so good or important that you could not manage without it, him or her
        * this book is an indispensable resource for reserachers
* repatriation
* repatriate
* commencement
    * the beginning of sth
    * A commencement is also a ceremony which students formally receive their diplomats
* claw
    * one of the sharp, curved nails at the end of each of the toes of some animals and birds
    * to cut esp. flesh with calws
    * Someone who claws his or her way somewhere uses a lot of effort to achieve something
        * The team trailed, 24–13, after one quarter but clawed to 26–18 by halftime.
    * claw your way
    * claw back
        * clawback
...
* substantial
    * large
    * general
    * relating to the main of most important things being considered
* line
    * in line with
        * similar to, or at the same level as sth
        * the company's results are in line with stock market expectations
        * we're seeking a pay rise that's in line with inflation
* landloard
    * a person who owns builiding or an area of land and is paid by other people for the use of it
    * owner
        * a person or organization that owns a a building or an area of land and is paid by other people for the use of it
    * bar manager
        * a man who is charged of a pub or bar
    * absentee
* landlady
* regulate
    * The Act regulates under what conditions it is permissible to treat various types of personal information
* engagement
    * external engagement
...
* dial-in numbers
    * is a special number used for participating in conference calls
* underreport
    * will be fired for allegedly underreporting his income and misusing company funds.
* for the time being
    * at this time
    * the uinion voted not to strike for the time being
    * the situation seems to be peaceful, for now at least
* repel
    * to enforce and repel legal claims
        Any violation of the provisions of data protection law can be punished with imprisonment
* rem
    * non rem sleep
        * and non-REM or non-rapid eye movement sleep
    * rem sleep
...
* appraise
    * to judge the quality, success, or needs of sb or sth
        * Social wokers appraise the needs of each family
    * Appraise also means to judge the worth of sth
        * A professional appraised my jewelry
    * At the end of each teaching practice, trainee teachers are aksed to arraise their own performance
    * He coolly appraised the situation, deciding which person would be most likely to succeed
    * to estimate the value, condition, quality, etc. of sb or sth after a careful examination
        * appraise sth for/at sth
            * the entire property is appraised at 7.2 million dollars
        * appraise sth for sth
            * the artwork was appraised for 10 million dollars
...
* abreast
    ...
    * if you keep abreast of a subject, you stay informed about new developments in it
        * Staying abreast of new software releases takes a lot of time
    * keep abreast of sth
        * to make sure you know all the most recent facts about a subject or situation
        * I try to keep abreast of any developments
* veritable
    * used to describe sth as another, more eciting, interesting, or unusual thing, as a way of emphasizing its character
...
* kaleidoscope
    * a tube-shaped device containing loose pieces of colored glass or plastic and mirrors which reflect changing patterns as the tube is turned
    * a changing and enjoyable mixture and pattern
...
* prosecution
    * legal
        ...
        * A number of the cases have results
    * the prosecution
...
* prosecute
    * legal
        ...
        * prosecute sb for sth
            * In this area, 26 people have been prosecuted for mortgage fraud in the past three year
    * continue
        * to continue to take part in a planned group of activities, esp. in a war
            * he seemed convinced that the U.S. would prosecute the war to its end
* clutch
    * hold
        * to hold or try to hold sth tightly, often because of a state of fear or anxiety
        * The preschooler clutched his mother tightly.
        * Slient and pale, she clutched ont her mother's hand
    * vehicle
    * group
    * bag
    * performing well
        * able to do sth when it is esp. needed
    * machine part
    * group
    * control
        * sb's clutches
            * the control of sb
            * He is in the clutches of that woman
            * he has fallen into the clutches of that woman
* crunch
    * make noise
    * calculate
    * difficulty
    * noise
    * an exercise
        * an exercise in which you lie on your back on the floor with your knees bent and your feet flat on the floor, and then raise your head ans shoulder
        * Doing crunches every day strengthens your abdominal muscles.
    * crunch (the) numbers
        * to deal with data by performing a large numnber of calculations
...
* crutch
    * a stick with a piece that fits under or around the arm which sb who is having difficulty walking leans on for support
...
* squat
    ...
    * live
        ...
        * they suatted (in) an old house in King's Cross when their money ran out
    * short
        * short and wide, usually in a way that is not attractive
    * sitting
        * a squatting position
    * exercise
        * an exercise in which you stand on the ground with your feet apart and raise and lower your bottom by bending and straightning your legs
    * place to live
...
* payroll
    * a list of the people employed by a company showing how much each one earns
        * the company is grwoning fast, and increasing the number of staff on its payroll
    * the total number of people employed by a company, or in economy
    ...
    * the total amount of money paid to the people employed by a particular company
        * With debts of 4 million dollars and a monthly payroll of 1.2 million dollars, the venture is clearly heading for trouble.
        * payroll costs
...
* severely
    * severely disabled adult
        * HUD "presumes" that severely disabled adults are lower income, and therefore agencies who serve this population do not have to document income status
* outstanding
    * excellent
        * very much better than usual; excent
        * you've done an outstanding job
    * not finished
        * not yet done, solved or paid
        * My credit cards usually have an oustanding balance
* sink
* shower
* toilet
* bathroom
...
* resident
    * living or staying in a place
        * resident in France/London etc.
            * If you want to take a British driving test you must be resident in the UK.
    * used to refer to sb who has a special skill or quality in a group or organization
        * she is the university's resident expert on Italian literature
        * He is the company's resident crown
    * sb who stay in a hotel
    ...
    * a person who has the legal right to live in a particular country that they were not born in
        * you will be considered a US residnet for tax purposes
    * sb who live in a place
        * the local residents were angry at the lack of parking spaces
    * medical
* consular
    * relating to consul or a consulate
    * the consular office
    * consular officers/officials/staff
...
* consulate
    * the offices or buuillding used by a consul
...
* recover
    ...
    * to become completely well again after an illness or injury
        * It took her a long time to recover from/after her heat operation
* heal
    * to make or become healthy or whole again
    * The wounds were gradually healing (up)
* whole
    * all of sth; the full amount
    * whole can also mean in one piece
    * Whole can also be used to emphasize sth
...
* patronize
    ...
    * be customer
* mood
    * The mood at the office these days is very tense.
* lexicographer
    * Her husband is a lexicographer and now working hard on a new dictionary.
* lexicography
...
* shortlist
    ...
    * a list of people who have been judged the most suitable for a job or prize, made from a longer list of people originally considered, and from which one person will be chosen
        ...
        * make a shortlist
        * on a shortlist
            * Candidates on the shortlist had three interviews each.
        * shortlist sb for sth
            * Two companies have been shortlisted for the contract.
    * to put sb or sth on a shortlist
* referendum
    ...
    * The MP insisted that it's time to hold a referendum on whether or not to stay in the European Union
* toxic
* poisonous
* gammon
    * an older middle-class white man whose face becomes [red] due to anger when expressing (typically right-wing) political opinions
* techlash
    * It is a negative feeling toward big technology companies like Facebook and Apple
* youthquake
    * cultural, political, or social change that has taken place because of the actions or influence of young people
* comforter
* invoice
* stray
    * stray cats
...
* streak
    ...
    * mark
        * to make lines of a different color in or on sth
        * her cheeks were streaked with sweat and dirt
* tenacity
    * the determination to continue what you are doing
* grit
    * stones
        * a very small piece of stone or sand
    * bravery
        * baravery and strength of character
    * grit your teeth
...
* spade
    * in spades
        ...
        * whatever you want to call it, you have it in spades!
* MP
...
* school-leaving certificate
    * it may alternatively be known as a 
        * school leaving certificate
    ...
    * is an academic qualification awarded for the completion of high school. 
* vocational
    ...
    * vocational training/course/program
        * People with inadequate vocational training find it difficult to re-enter the workforce.
* cornerstone
    * stone in building
    * most important part
...
* speculative
    ...
    * guess
        * based on guess and not on information
...
* black eye
    *  periorbital hematoma, or shiner, is bruising around the eye commonly due to an injury to the face rather than to the eye
* permanent residence
    * permanent residency
    * Permanent residency refers to people's resident status in a country of which they are not citizens.
    * This is usually for a permanent period; a person with such status is known as a permanent resident.
    * In the United States, such a person is officially referred to as a Lawful Permanent Resident
    * will you keep permanent residence outside of this country? if yes where?
* allowance
...
* premises
    * "The premises" of a business or institution are all the buildings and land that it occupies on one site
    ...
    * the land and buildings owned by someone, especially by a company or organization
        * off/on the premises
            * Everything is made right here on the premises.
        * business/commercial/company premises
* assumption
* indefinite
...
* gymnastics
    ...
    * Legal arguments require incredible mental/verbal gymnastics (= the ability to think/speak cleverly and quickly).
* physique
    * the appearance, esp. shape and size, of a human body
    * a small/lager physique
    * a dancer's physique
* umbilical
    * umbilical cord
* shotgun
    ...
    * to drink an alcoholic drink from a can very quickly, by making a hole in the can, putting your mouth over the hole and then opening the can at the top
        * I saw some workers shotgunning beers across the street.
* persuade
* coerce
    * to persuade sb forcefully to do sth that he or she may not want to do
    * I don't think anybody should be coerced into leaving
    * the court heard that the six defendants have been coerced into making a confession
* leech
    ...
    * to get money, food, etc. from other people, especially without working for it or doing anything to deserve it
        * I don't want to leech off my parents any longer.
* rule
    * rule out
        * we can try to rule in or rule out our hypotheses
* ping
    * Trying to conencto the database with the same crednetials the application logic server uses can refute the second hypothesis, while pingin the database server may be able to refute the first, depending on network topology, firewall rules, and other factors
* draw
    * picture
    * move
    * pull/pull in
    ...
    * drawn-out
        ...
        * when you are dealing with more complicated and drawn-out cases, this documentation may be crucial in helping you remember exactly what happend and prevent having to repeat these steps
* lengthy
* protracted
    * lasting for long time or made to last longer than necessary
...
* hodge podge
    * hodgepodge
    * a confused mixture of different thigs
        * it was a hodgepodge of theories
        * New Age thinking seems to be a hodgepodge of old and new ideas.
    * making changes in a systematic and documented fashion will help you return the system to its pre-test setup, rather than running in an unknown hodge-podge configuration
* farrago
* mishmash
* disconfirm
    * show that (a belief or hypothesis) is not or may not be true.
    * benchmarking tools and load generator can result just as easily from a disconfirming experiment as a supporting one
* outlive
    * to live or exist longer than sb or sth
...
* oddity
    * sb or sth that is strange or unusual
...
* leisure
    * at leisure
        ...
        * slowly and for as long as you like
        * They’ll need time to think about the situation at leisure.
* periodic
    * repeated event
    * time
* woefully
    * (of a bad situation) extremely; very:
...
* wraith
    ...
    * something that is pale or weak and without a clear shape
        * He watched the misty wraiths of moisture making patterns on the window pane
* limb
* unearth
    * dig earth
        * to find sth by digging in the ground
    * discover
...
* cumulus
* r and g
    * random elment in games
    * you can lose simply b R&G
* nosedive
    ...
    * to suddenly fall to the ground with the front pointing down
        * Sepctators in the world watched in horror as the plane nosedived
    * house price nosedived without warning
* sassy
...
* shirk
* courier
    * a person who carreis or documents for sb else
    * messanger
        * I want to have this package delivered by motorcycle courier
        * we can send the document by courier
        * a courier service/company/firm
    * on holiday
...
* inland
    ...
    * toward the middle of a country, away from the sea
    * away from the sea
    ...
    * lcoated towards the middle of a country away from the coast
* coastal
* upstate
* interleave
    * Outalator lets users view a timeinterleaved list of notificagtions for multiple queus at once
    * to put layers or flat pieces of sth between layers or flat pieces of sth else
...
* delve
    * delve into
        * to search, esp. as if by digging, in order to find a thing or information
...
* bait
    * food
        ...
        * bait is also anything used to persuade sb to do sth
    * put bait on
        * put a bait on a hook or in a trap
        * you can bait the mousetrap with a piece of cheese
    * make angry
        * to intentionally make sb angry by saying or doing annoying things
        * she enjoys baiting her brother by teasing him about his girlfrined
...
* fiddle
    ...
    * cheat
    * move about
        * to move things about or touch things with no particualr purpose
    ...
    * to change figures dishonestly, often in order to get more money
        * fiddle your overtime/expenses
            * the report criticized officers who fiddled their overtime and tax inspects how received tax-free bonuses
    * to change sth very slightly
        * fiddle with sth
            * If you fiddle with the figures in the investment column, you should be able to get your budget to balance.
    * fiddle the books
        * to dishonestly change a company's accoutns or financial records
    * on the fiddle
        * involved in dishonest behaviour, usually to get money
            * one in two holiday makers claiming for lost luggage could be on the fiddle, claims a leading travel insurance firm
* holidaymaker
    * a person who is on holiday away from where they usually live
* ablaze
    * burning or very bright
    * her eyes were ablaze with excitement
* scene
    * play/move
        * a part of a play or movie in which the actions says in one place for a continuous period
        * the opning scene of the movie was filmed in New York City
    * view
    * place
    * event
    * area
...
* per
    * as per sth
        * according to sth
        * as per your instructions/letter/request
    ...
    * used when talking about pieces, rates, etc. to mean the amount for each one
    * per day/hour/mongth
    * per head/person
    * per litre/million/minute
* coop
    * a cage where small animals are kept, esp. chickens
        * a chicken coop
* cooped
    * cooped up
        * if you are cooped up somewhere, you are in a small closed space from which you cannot space, or you feel as if you are
...
* penmanship
    * the ability to write neatly, or the activity of learning to do this
* ruse
    * a trick intended to deceive sb
...
* soot
    * a black powder produced when coal, wood, etc., is burned
    * It can be dangerous to let too much soot accumulate inside a chimney.
* smut
    * pictures, writing, language, or performances that deal with sex and are offensive
    * sexual material
        * magazines, books, pictures, filmsor jokes that offend some people because they relate to sex
    * dirt
        * dirt or ash (= powder left when something has burned) that makes a mark on something
* limbic
    * limbic system
        * the paleomammalian cortex
* digestible
    * it presents an easily digestible guide for everyone from beginners to advanced German speakers
* glean
...
* exemption
    * the fact of not having to obey a rule or do something that other people have to do
        * he was granted exemption from military service during WW2
    ...
    * exemption from
    * exemption from doing sth
    * personal exemption
        * the amount of income you can earn each year before paying tax
        * the personal exemption for all taxplayers has been increased by 200 dollars to 2600 dollars
* dopey
    * drugged
...
* apprentice
    * sb who works for an expert to learn a particular skill or job
...
* substance
* subsistence
    * what a person needs in order to stay live
    * Art satisfies a need beyond more subsistence
    * the state of having what you need in order to stay alive, but no more
        * the family was living at subsistence level
    * enough money or food to keep yourselves alive
* travel card
...
* bestow
    * to give sth as an honor or present
...
* pout
    * to show annoyance esp. by pressing the lips together or pushing out the lower lip
...
* sulk
    ...
    * she puts and sulks, and she almost never smiles or laughs
...
* brood
    * a group of young brids all born at the same time, or a person's children
    * think
        * to think silently for a long time about things that make you sa,d worreid and angry
...
* pasture
    ...
    * he sheep were grazing on the lush green pastures.
* uggo
    * an angury person
* fatty
    * a fat person
